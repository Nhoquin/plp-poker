...
(function(){
  ...
  function loadTheme(){
    ...
    if(!document.querySelector('link[data-plp-home-stable-v35]')){
      ...
      s35.rel='stylesheet';
      s35.href='home-stable-v35.css?v=48';
    ...
    if(!document.querySelector('link[data-plp-global-bg-v36]')){
      ...
      g36.rel='stylesheet';
      g36.href='global-background-v36.css?v=48';
    ...
    if(!document.querySelector('link[data-plp-home-logo-v37]')){
      ...
      l37.rel='stylesheet';
      l37.href='home-logo-v37.css?v=48';
  ...
  function loadFinanceLedgerV33(){
    ...
    f33.src='finance-ledger-v33.js?v=48';
  ...
  function loadFinanceOverviewV32(){
    ...
    f32.src='finance-overview-v32.js?v=48';
  ...
  function loadAdminAccessV26(){
    ...
    x.src='admin-access-v26.js?v=48';
