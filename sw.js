const CACHE='plp-2026-v10';
const CORE=['./','./index.html','./manifest.json','./assets/brand-bg.png','./assets/league-logo.png','./assets/app-icon.png','./assets/apple-touch-icon.png','./assets/icon-192.png','./assets/icon-512.png'];
